...
<hr>
   <h2 align="center">Data Pesanan Anda</h2>
<hr>    
	...
	<?php
		...
		$sql  = "SELECT * FROM tbl_pemesanan WHERE Email ='$email'";
	...
	while($data = mysql_fetch_array($rest) )
	{
     ...
     <div align="center"><a href=cetak_bukti.php?id=<?php echo $email?>><input type="submit"  class="btn btn-success" value="CETAK BUKTI" /></a></div>                    
